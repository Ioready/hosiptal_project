...
<div id="page-content">
    ...
    <div class="row text-center">
        <div class="col-sm-6 col-lg-3 mb-4">
            <a href="<?php echo base_url()."users/index/No";?>" class="widget widget-hover-effect2 rounded" style="border-radius: 20px;;">
                <div class="widget-extra themed-background" style="background-color:#9efea6; box-shadow: 0px 0px 4px rgba(0, 0, 0, 0.4);">
                    <h4 style="font-size:16px; font-weight:600; color:black;">Inactive Users</h4>
                </div>
        ...
        <div class="col-sm-6 col-lg-3 mb-4">
            <a href="<?php echo base_url()."users/index/Yes";?>" class="widget widget-hover-effect2 rounded" style="border-radius: 10px; ">
                <div class="widget-extra themed-background-dark">
                    <h4 style="font-size: 16px; font-weight:600; color:white;">Activated Users</h4>
                </div>
    ...
    <div class="block full">
        ...
        <table id="users" class="table table-vcenter table-condensed table-bordered" style="background-color: #F0F8FF;">
    <thead>
        <tr>
