                ...
                <div class="modal-body">
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-12" >
                                <div class="form-group">
                                    <label class="col-md-3 control-label">User Size</label>
                                    <div class="col-md-9">
                            ...
                            <div class="col-md-12" >
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Used_type</label>
                                    <div class="col-md-9">
                            ...
                            <div class="col-md-12" >
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Min Mmount</label>
                                    <div class="col-md-9">
                            ...
                            <div class="col-md-12" >
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Percentage in amount</label>
                                    <div class="col-md-9">
