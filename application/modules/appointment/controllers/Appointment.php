...
// print_r($this->data['doctors']);die;
    ...
    //         'where' => array(
    //             'users.delete_status' => 0,
    //             'doctors.facility_user_id'=>$hospital_id
    //         ),
    //         'order' => array('users.id' => 'desc'),
    //     );
    //     $this->data['doctors'] = $this->common_model->customGet($option);
...
// print_r($this->data['practitioner']);die;
    ...
    function open_model_new_patient() {
    ...
    $option = array(
        ...
        $this->load->admin_render('add_new_patient_appointment', $this->data, 'inner_script');
            ...
            if ($patient_id) {
                ...
                $option3 = array(
                    ...
                    'data' => array(
                        ...
                        'type' => $this->input->post('storedDataType') ? $this->input->post('storedDataType') : null,
